 ...
 % \emph{Current} & \\
 	...
 	\emph{Current} & \emph{Crossover Health} \\
		& 
			...
			\item Build and implement machine learning models to both predict medical outcomes and improve operational procedures. %(No shows/inpatient)
			\item Build ETL processes with Python scripts to transform data from sources such as API calls, insurance flat files, internal sources, etc. into MySQL and Tableau.  %(ETL)/ Data sources: API calls to SurveyMonkey and Google sheets, weirdly formatted text files...
...
%		&
%			\begin{itemize}
%			\item Investigated the possibility of using a new, geometrical method to measure quasar distances. 
